...
plot_foldChange_pValues <- function(foldchange, rawpvalue, pvalue_thr = 0.05, lfc_thr = 0.58) {
  ### Set thresholds
  ...
  # Volcano plot
  ggplot2::ggplot(samples_peaks_profile) +
    ...
    ggplot2::theme(legend.position = "none",
          plot.title = ggplot2::element_text(size = rel(1.5), hjust = 0.5),
